...
class IBizEditForm extends IBizForm {
    ...
    public save2(arg: any = {}): Subject<any> {
        var _this = this;
        if (!arg)
            arg = {};
        // if(IBizApp_Data)
    ...
    public remove(arg: any = {}): Subject<any> {
        var _this = this;
        if (!arg)
            arg = {};
        // if(IBizApp_Data)
    ...
    public wfstart(arg: any = {}): Subject<any> {
        var _this = this;
        if (!arg)
            arg = {};
        // if(IBizApp_Data)
    ...
    public wfsubmit(arg: any = {}): Subject<any> {
        var _this = this;
        if (!arg)
            arg = {};
        // if(IBizApp_Data)
    ...
    public doUIAction(arg: any = {}): Subject<any> {
        var _this = this;
        if (!arg) arg = {};
